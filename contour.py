...
maxvalue=max(z)
print maxvalue
smooth=np.linspace(0,3,50, endpoint=True)
#plt.figure(num=None, figsize=(8, 6), dpi=80, facecolor='w', edgecolor='k')
#fig = plt.figure()
plt.contourf(xi, yi, zi, smooth, contoursize=(20, 15))
...
plt.title('Peak interstory drift of a 40 story building for fault-normal component of ground motion', y=1.05, fontsize=30)
