...
## scripts below are for plotting purspose alone

import matplotlib.pyplot as plt

#plt.plot(time,roof,linewidth=2.0, color='red')
#plt.title('3st_S_37_30_ns_lin',fontsize=16,fontname="Times New Roman Bold")
...
#f=open('S_05_30_lindrifts.txt','w')
#for i in range(0,N):
#  f.write(str(drifts[i])+' ')
